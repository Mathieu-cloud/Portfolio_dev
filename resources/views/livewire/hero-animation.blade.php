 <section id="hero" x-data="heroAnimation"
     class="flex flex-col items-center justify-center relative overflow-hidden h-screen">

     <div class="relative z-10 text-center w-full">
         <div x-show="showName" x-transition:enter="transition ease-out duration-2000 delay-800"
             x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
             x-transition:leave="transition ease-in duration-2000" x-transition:leave-start="opacity-100"
     ...
     <div
         class="absolute bottom-12 left-1/2 transform -translate-x-1/2 flex items-center gap-8 text-lg uppercase tracking-[0.3em] text-[#dbe6cb]">
         <a href="#projects" class="group relative py-2">
             <span>Projets</span>
             <span
                 class="absolute bottom-0 left-0 w-0 h-[1px] bg-[#dbe6cb] transition-all duration-300 group-hover:w-full"></span>
         </a>
