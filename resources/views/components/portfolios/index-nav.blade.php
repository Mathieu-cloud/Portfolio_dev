<nav x-data="{
    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative flex h-16 items-center justify-between">
            ...
            <div class="flex shrink-0 items-center">
                <a href="/" class="group flex items-center font-logo text-xl font-black tracking-tighter">
                    <span
                        class="text-blanc transition-all duration-300 group-hover:text-[#22d3ee] group-hover:drop-shadow-[0_0_10px_rgba(34,211,238,0.8)]">
                        &lt;
                    </span>
                    <span class="bg-gradient-to-r from-blanc to-gray-500 bg-clip-text text-transparent">
                        MM
                    </span>
                    <span
                        class="text-blanc transition-all duration-300 group-hover:text-[#22d3ee] group-hover:drop-shadow-[0_0_10px_rgba(34,211,238,0.8)]">
            ...
            <div class="hidden sm:ml-6 sm:block">
                <div class="flex items-center space-x-1">
                    <template
                        ...
                        <a :href="'#' + item.id" @click="activeSection = item.id"
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-200"
        ...
        @click.away="open = false" class="sm:hidden bg-[#222733]/60 border-t border-white/10">
